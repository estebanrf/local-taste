...
Your task:
1. Use search_web to find restaurants serving this dish (search "[dish] best restaurant [city]", "where to eat [dish] [city] Google Maps")
2. Find EXACTLY 5 restaurants
3. For each restaurant, determine: name, address, Google Maps URL (if found), Google rating, review count, price level, and rank 1-5
